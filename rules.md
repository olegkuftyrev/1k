...
## Core vs. Client Files

Files are prefixed to distinguish core company documents from client-adapted versions.
...
**Rule:** never mix core and client content in the same file.
